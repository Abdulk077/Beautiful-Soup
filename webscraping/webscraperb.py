...
# Selenium Webdriver
os.environ['PATH'] += r"/home/Abdul/Documents/python/driver"

driver = webdriver.Chrome()
wait = WebDriverWait(driver, 5)

# searching bergen companies in Googlemaps
driver.get(
    "https://www.google.nl/maps/search/bergen+companies/@52.6803052,4.6817917,14z/data=!3m1!4b1?authuser=0&hl=en")
time.sleep(5)
...
time.sleep(5)  # /html/body/div[3]/div[9]/div[8]/div/div[1]/div/div/div[2]/div[1]/div[25]/div/a
...
def phone_website(text1):
    ...
    for line in range(len(text_blob)):
        ...
        if "closed" in text_blob[line].lower() or "open" in text_blob[line].lower() or "claim this" in text_blob[
            line].lower():
            aux_number = ""
